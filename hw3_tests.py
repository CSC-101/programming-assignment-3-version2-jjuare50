...
class TestCases(unittest.TestCase):
    ...
    def test_population_total1(self):
        input = hw3.population_total(full_data)
        expected = 318857056
        self.assertEqual(input, expected)

    def test_population_total2(self):
        input = hw3.population_total(reduced_data)
        expected = 655813
        self.assertEqual(input, expected)
    ...
    def test_filter_by_state(self):
        input = hw3.filter_by_state(reduced_data, 'CA')
    ...
    data.CountyDemographics(
        ...
        'CA')]
        self.assertEqual(input, expected)
        # test above works perfectly fine yet the test fails, there is no differences
        # between the expected and actual result

    def test_filter_by_state2(self):
        input = hw3.filter_by_state(reduced_data, 'AL')
        expected = [data.CountyDemographics(
        {'Percent 65 and Older': 13.8,
         'Percent Under 18 Years': 25.2,
         'Percent Under 5 Years': 6.0},
    ...
    def test_population_by_education1(self):
        san_luis_obispo_county = next(
            (county for county in reduced_data if county.county == "San Luis Obispo County"), None)
        if san_luis_obispo_county:
            result = hw3.population_by_education([san_luis_obispo_county], "Bachelor's Degree or Higher")
            expected = 87911.145
            self.assertEqual(result, expected)

    def test_population_by_education2(self):
        autauga_county = next(
            (county for county in reduced_data if county.county == "Autauga County"), None)
        if autauga_county:
            result = hw3.population_by_education([autauga_county], "High School or Higher")
            expected = 47418.12
            self.assertEqual(result, expected)
    ...
    def test_population_by_education3(self):
        ...
        if autauga_county:
            result = hw3.population_by_education([autauga_county], "CA")
            expected = 0.0
            self.assertEqual(result, expected)
    ...
    def test_population_by_ethnicity(self):
        ...
        if san_luis_obispo_county:
            result = hw3.population_by_ethnicity([san_luis_obispo_county], "Hispanic or Latino")
            expected = 61398.26
            self.assertEqual(result, expected)
    ...
    def test_population_by_ethnicity2(self):
        ...
        if san_luis_obispo_county:
            result = hw3.population_by_ethnicity([san_luis_obispo_county], "Indian")
            expected = 0.0
            self.assertEqual(result, expected)
    ...
    def test_population_below_poverty_level1(self):
        ...
        if san_luis_obispo_county:
            result = hw3.population_below_poverty_level([san_luis_obispo_county])
            expected = 39908.869
    ...
    def test_population_below_poverty_level1(self):
        ...
        if autauga_county:
            result = hw3.population_below_poverty_level([autauga_county])
            expected = 6702.795
            self.assertAlmostEqual(result, expected)
    ...
    def test_percent_by_education1(self):
        input = hw3.percent_by_education(reduced_data, "Bachelor's Degree or Higher")
        expected = 29.7514827
        self.assertAlmostEqual(input, expected, places=7)

    def test_percent_by_education2(self):
        input = hw3.percent_by_education(reduced_data, "Autauga County")
        expected = 0.0
        self.assertEqual(input, expected)

    # test percent_by_ethnicity
    def test_percent_by_ethnicity1(self):
        input = hw3.percent_by_ethnicity([
            data.CountyDemographics(
                {'Percent 65 and Older': 13.8,
                 'Percent Under 18 Years': 25.2,
                 'Percent Under 5 Years': 6.0},
        ...
        expected = 85.0659823045127
        self.assertEqual(input, expected)

    def test_percent_by_ethnicity2(self):
        input = hw3.percent_by_ethnicity(reduced_data, "Autauga County")
        expected = 0.0
        self.assertEqual(input, expected)
    # test percent_below_poverty_level
    def test_percent_below_poverty_level1(self):
        input = hw3.percent_below_poverty_level([
            data.CountyDemographics(
                {'Percent 65 and Older': 13.8,
                 'Percent Under 18 Years': 25.2,
                 'Percent Under 5 Years': 6.0},
    ...
    def test_education_greater_than(self):
        input = hw3.education_greater_than(reduced_data, "Bachelor's Degree or Higher", 35.2)
        expected_county = [data.CountyDemographics(
                {'Percent 65 and Older': 11.5,
                 'Percent Under 18 Years': 21.7,
                 'Percent Under 5 Years': 5.8},
                'Yolo County',
                ...
                {'2010 Population': 200849,
                 ...
                 'Population per Square Mile': 197.9},
                'CA')]
        expected = [expected_county]
        self.assertEqual(input, expected)
    # test education_less_than
    def test_education_less_than(self):
        input = hw3.education_less_than(reduced_data, "Bachelor's Degree or Higher", 15.2)
        expected = [
            data.CountyDemographics(
                {'Percent 65 and Older': 15.3,
                 'Percent Under 18 Years': 25.1,
    ...
    def test_ethnicity_greater_than(self):
        input = hw3.ethnicity_greater_than(reduced_data, "White Alone", 95)
        expected = [
            data.CountyDemographics(
                {'Percent 65 and Older': 19.6,
                 'Percent Under 18 Years': 25.6,
    ...
    def test_ethnicity_less_than(self):
        input = hw3.ethnicity_less_than(reduced_data, "White Alone", 76)
        expected = [
            data.CountyDemographics(
                {'Percent 65 and Older': 11.5,
                 'Percent Under 18 Years': 21.7,
    ...
    def test_below_poverty_level_greater_than(self):
        input = hw3.below_poverty_level_greater_than(reduced_data, 20.0)
        expected = [
            data.CountyDemographics(
                {'Percent 65 and Older': 15.3,
                 'Percent Under 18 Years': 25.1,
    ...
    def test_below_poverty_level_less_than(self):
        input = hw3.below_poverty_level_less_than(reduced_data, 11.5 )
        expected = [
            data.CountyDemographics(
                {'Percent 65 and Older': 18.1,
                 'Percent Under 18 Years': 21.6,
